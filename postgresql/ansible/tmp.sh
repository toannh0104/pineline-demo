...
# curl -L -o pgtune.zip https://github.com/iterativo-git/pgtune/archive/iterativo-tune.zip
# unzip pgtune.zip
# PGDATA=`systemctl show -p Environment "postgresql-11" | sed 's/^Environment=//' | tr ' ' '\n' | sed -n 's/^PGDATA=//p' | tail -n 1`

# PGVERSION is the full package version, e.g., 11.0
# Note: the specfile inserts the correct value during package build
PGVERSION=11
# PGMAJORVERSION is major version, e.g., 11 (this should match PG_VERSION)
