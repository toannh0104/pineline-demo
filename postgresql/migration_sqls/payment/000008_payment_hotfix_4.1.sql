...
CREATE TABLE payment_dev.order_locking (
  ...
  wait_duration_check_status_in_millisecond BIGINT                                    NULL,
  max_retry_check_status                    BIGINT                                    NULL,
  current_retry_check_status                BIGINT                                    NULL,
  wait_duration_cancel_in_millisecond       BIGINT                                    NULL,
  max_retry_cancel                          BIGINT                                    NULL,
  current_retry_cancel                      BIGINT                                    NULL,
